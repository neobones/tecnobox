...
## Ejemplo de crear entidades desde la base de datos

php artisan code:models

## Crear controladores, ejemplo
...
use App\Models\Post; // asegúrate de usar el namespace correcto para tu modelo Post
